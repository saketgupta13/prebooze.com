...
/** One paid marketing (Meta ad campaign) arrangement — either a one-time
 * per-event purchase, or a billed period generated by a MarketingSubscription
 * (isSubscriptionPeriod true, periodStart/periodEnd set). Deliberately never
 * carries the real Meta ad spend or Prebooze's margin — only what was paid. */
 ...
 * organizer's/venue's events for a rolling 30-day window. */
 ...
 * commission, or promoter figures; only what's needed to show "how is my
 * event performing." */
