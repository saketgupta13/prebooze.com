...
/** Every promoter this organizer has worked with, in one place — profile,
 * contact, real bank details (not just masked last4 — the organizer is the
 * one who actually has to wire this money, no split-payment rail exists),
 * and what's owed. Per-event breakdown + mark-received status still lives on
 * Payouts.tsx; this is the promoter-centric roster + payout details. */
export default function OrganizerPromoters() {
  const [rows, setRows] = useState<OrgPromoter[]>([]);
  ...
  return (
    <div>
      ...
      <p className="muted small" style={{ marginBottom: 18 }}>
        Everyone you've allowed to promote your events — their profile, bank details for paying them out, and what
