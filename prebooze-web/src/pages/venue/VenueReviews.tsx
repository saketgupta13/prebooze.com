...
import { venuePartner, socialReviews, type VenueReview } from '../../api';
 ...
 * backend shape (SocialService.venueReviews mirrors .reviews()), just
 * keyed by this venue's own id instead of an organizer's. */
export default function VenueReviews() {
  ...
  useEffect(() => {
    venuePartner
      .myListing()
      .then((venue) => socialReviews.venue(venue.id))
      .then(setReviews)
