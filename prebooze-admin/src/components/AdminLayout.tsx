...
const EXTRA_NAV = [
  ...
  { to: '/events-live', icon: '🎪', label: 'Events (live)' },
  ...
  { to: '/staff-live', icon: '🧑‍💻', label: 'Staff & roles (live)' },
  { to: '/settings-live', icon: '⚙', label: 'Settings (live)' },
  { to: '/content-live', icon: '📄', label: 'Content (live)' },
  { to: '/ops-live', icon: '🏷', label: 'Categories/Promos/Reels/Reviews (live)' },
  { to: '/locations-live', icon: '🌍', label: 'Locations (live)' },
  ...
  { to: '/abandoned-carts-live', icon: '🛒', label: 'Abandoned carts (live)' },
    ...
    <>
      ...
      <div className="shell">
        <nav className="sidebar">
          ...
          <NavLink to="/events-live" className={({ isActive }) => `navitem ${isActive ? 'on' : ''}`}>
            <span>🎪</span>
          ...
          <NavLink to="/staff-live" className={({ isActive }) => `navitem ${isActive ? 'on' : ''}`}>
            <span>🧑‍💻</span>
            <span>Staff &amp; roles (live)</span>
          </NavLink>
          <NavLink to="/settings-live" className={({ isActive }) => `navitem ${isActive ? 'on' : ''}`}>
            <span>⚙</span>
          ...
          <NavLink to="/locations-live" className={({ isActive }) => `navitem ${isActive ? 'on' : ''}`}>
            <span>🌍</span>
          ...
          <NavLink to="/abandoned-carts-live" className={({ isActive }) => `navitem ${isActive ? 'on' : ''}`}>
            <span>🛒</span>
            <span>Abandoned carts (live)</span>
          </NavLink>
